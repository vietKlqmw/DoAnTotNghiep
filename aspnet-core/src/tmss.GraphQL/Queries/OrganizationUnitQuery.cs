...
using tmss.Core.Base;
using tmss.Core.Extensions;
using tmss.Dto;
using tmss.Types;

namespace tmss.Queries
{
    public class OrganizationUnitQuery : tmssQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
