...
{
    public class SubscriptionPaymentExtensionDataRepository : tmssRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<tmssDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
