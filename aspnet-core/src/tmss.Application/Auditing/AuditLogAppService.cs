...
using EntityHistoryHelper = tmss.EntityHistory.EntityHistoryHelper;

namespace tmss.Auditing
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Administration_AuditLogs)]
    public class AuditLogAppService : tmssAppServiceBase, IAuditLogAppService
    {
