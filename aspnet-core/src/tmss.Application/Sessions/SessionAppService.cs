...
{
    public class SessionAppService : tmssAppServiceBase, ISessionAppService
    {
        ...
        public async Task<GetCurrentLoginInformationsOutput> GetCurrentLoginInformations()
        {
            var output = new GetCurrentLoginInformationsOutput
            {
                Application = new ApplicationInfoDto
                {
                    ...
                    Currency = tmssConsts.Currency,
                    CurrencySign = tmssConsts.CurrencySign,
                    AllowTenantsToChangeEmailSettings = tmssConsts.AllowTenantsToChangeEmailSettings,
