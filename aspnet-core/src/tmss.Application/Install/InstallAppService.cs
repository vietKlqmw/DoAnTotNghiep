...
using tmss.Migrations.Seed.Host;
...
namespace tmss.Install
{
    [AbpAllowAnonymous]
    [DisableAuditing]
    public class InstallAppService : tmssAppServiceBase, IInstallAppService
    {
        private readonly AbpZeroDbMigrator<tmssDbContext> _migrator;
        ...
        private string GetConnectionString()
        {
            ...
            return connectionStrings.Property(tmssConsts.ConnectionStringName).Value.ToString();
        }
