...
using tmss.DashboardCustomization.Dto;
using Newtonsoft.Json;

namespace tmss.DashboardCustomization
{
    [AbpAuthorize]
    public class DashboardCustomizationAppService : tmssAppServiceBase, IDashboardCustomizationAppService
    {
