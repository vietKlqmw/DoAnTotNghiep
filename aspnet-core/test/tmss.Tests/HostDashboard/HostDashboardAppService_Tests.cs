...
using tmss.MultiTenancy.HostDashboard;
...
namespace tmss.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(tmssDbContext context, SubscriptionPayment subscriptionPayment)
        {
