...
@Component({
  selector: 'tmss-search-input',
  templateUrl: './tmss-search-input.component.html',
  styleUrls: ['./tmss-search-input.component.less'],
  providers: [
    {
      provide: NG_VALUE_ACCESSOR,
      useExisting: forwardRef(() => TmssSearchInputComponent),
      multi: true
    }]
})
export class TmssSearchInputComponent implements ControlValueAccessor, OnInit, AfterViewInit, OnChanges {
