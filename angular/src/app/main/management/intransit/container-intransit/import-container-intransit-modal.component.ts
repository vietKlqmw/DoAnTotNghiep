...
import { ProdContainerIntransitServiceProxy } from '@shared/service-proxies/service-proxies';
...
@Component({
    ...
    templateUrl: './import-container-intransit-modal.component.html',
    styleUrls: ['../../../import-modal.less'],
})
export class ImportContainerIntransitComponent extends AppComponentBase {
    ...
    constructor(
        ...
        super(injector);
        this.uploadUrl = AppConsts.remoteServiceBaseUrl + '/Product/ImportContainerIntransitFromExcel';
        { }
    }
    ngOnInit() {
