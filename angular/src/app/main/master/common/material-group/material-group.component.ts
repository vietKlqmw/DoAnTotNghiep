...
import { MasterMaterialGroupDto, MasterMaterialGroupServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class MaterialGroupComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterMaterialGroupDto = new MasterMaterialGroupDto();
    datas: MasterMaterialGroupDto = new MasterMaterialGroupDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterMaterialGroupServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getMaterialGroupSearch(
            this.code,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getMaterialGroupSearch(
            this.code,
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
