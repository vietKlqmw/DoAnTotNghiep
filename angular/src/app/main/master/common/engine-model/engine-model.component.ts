...
import { MasterEngineModelDto, MasterEngineModelServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class EngineModelComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterEngineModelDto = new MasterEngineModelDto();
    datas: MasterEngineModelDto = new MasterEngineModelDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterEngineModelServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getEngineModelSearch(
            this.code,
            this.name,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getEngineModelSearch(
            this.code,
            this.name,
            '',
            this.paginationParams.skipCount,
