...
import { MasterFuelTypeDto, MasterFuelTypeServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class FuelTypeComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterFuelTypeDto = new MasterFuelTypeDto();
    datas: MasterFuelTypeDto = new MasterFuelTypeDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterFuelTypeServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getFuelTypeSearch(
            this.code,
            this.name,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getFuelTypeSearch(
            this.code,
            this.name,
            '',
            this.paginationParams.skipCount,
