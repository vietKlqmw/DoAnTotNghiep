...
import { MasterCarSeriesDto, MasterCarSeriesServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CarSeriesComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterCarSeriesDto = new MasterCarSeriesDto();
    datas: MasterCarSeriesDto = new MasterCarSeriesDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterCarSeriesServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getCarSeriesSearch(
            this.code,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getCarSeriesSearch(
            this.code,
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
