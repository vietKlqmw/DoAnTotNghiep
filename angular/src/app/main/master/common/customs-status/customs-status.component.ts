...
import { MasterCustomsStatusDto, MasterCustomsStatusServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class CustomsStatusComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterCustomsStatusDto = new MasterCustomsStatusDto();
    datas: MasterCustomsStatusDto = new MasterCustomsStatusDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterCustomsStatusServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getCustomsStatusSearch(
            this.code,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getCustomsStatusSearch(
            this.code,
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
