...
import { MasterMaterialTypeDto, MasterMaterialTypeServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class MaterialTypeComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterMaterialTypeDto = new MasterMaterialTypeDto();
    datas: MasterMaterialTypeDto = new MasterMaterialTypeDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterMaterialTypeServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getMaterialTypeSearch(
            this.code,
            this.name,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getMaterialTypeSearch(
            this.code,
            this.name,
            '',
            this.paginationParams.skipCount,
