...
import { MasterCarfamilyDto, MasterCarfamilyServiceProxy } from '@shared/service-proxies/service-proxies';
import { ceil } from 'lodash';
import { finalize } from 'rxjs/operators';

@Component({
    selector: 'app-carfamily',
...
export class CarfamilyComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterCarfamilyDto = new MasterCarfamilyDto();
    datas: MasterCarfamilyDto = new MasterCarfamilyDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterCarfamilyServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getCarfamilySearch(
            this.code,
            '',
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getCarfamilySearch(
            this.code,
            '',
            this.paginationParams.skipCount,
            this.paginationParams.pageSize
