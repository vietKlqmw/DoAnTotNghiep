...
import { MasterFactoryDto, MasterFactoryServiceProxy } from '@shared/service-proxies/service-proxies';
...
export class FactoryComponent extends AppComponentBase implements OnInit {
    ...
    selectedRow: MasterFactoryDto = new MasterFactoryDto();
    datas: MasterFactoryDto = new MasterFactoryDto();
    ...
    constructor(
        injector: Injector,
        private _service: MasterFactoryServiceProxy,
    ...
    searchDatas(): void {
        this.isLoading = true;
        this._service.getFactorySearch(
            this.plantName,
            this.branchNo,
    ...
    getDatas(paginationParams?: PaginationParamsModel) {
        return this._service.getFactorySearch(
            this.plantName,
            this.branchNo,
            this.addressLanguageEn,
            '',
